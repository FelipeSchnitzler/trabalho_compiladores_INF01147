...
{
       0,    77,    77,    80,    86,    91,    96,   101,   102,   105,
     106,   111,   112,   115,   118,   129,   143,   144,   146,   157,
     160,   161,   163,   164,   167,   168,   175,   181,   185,   186,
     187,   188,   189,   192,   201,   206,   210,   219,   231,   248,
     264,   282,   283,   286,   290,   295,   301,   305,   309,   313,
     319,   323,   328,   332,   336,   342,   346,   350,   354,   358,
     364,   368,   372,   378,   382,   386,   390,   396,   397,   398,
     399,   400,   401,   402
};
#endif
...
#line 118 "src/parser.y"
        ...
        Symbol *retorno = find_symbol(stack->next->table,(yyvsp[-5].valor_lexico)->valor);
        if(retorno != NULL){
            printf("Erro na linha %d, funcao '%s' já declarada na linha %d\n",get_line_number(), (yyvsp[-5].valor_lexico)->valor, retorno->linha);
            exit(ERR_DECLARED);
        } //assume pilha tem profundidade = 2 
        insert_symbol(stack->next->table,(yyval.arvore)->label,get_line_number(),FUNCAO,(yyvsp[0].tiposvar));
...
#line 129 "src/parser.y"
        ...
        Symbol *retorno = find_symbol(stack->next->table,(yyvsp[-4].valor_lexico)->valor);
        if(retorno != NULL){
            printf("Erro na linha %d, funcao '%s' já declarada na linha %d\n",get_line_number(), (yyvsp[-4].valor_lexico)->valor, retorno->linha);
            exit(ERR_DECLARED);
        }  //assume pilha tem profundidade = 2 
        insert_symbol(stack->next->table,(yyval.arvore)->label,get_line_number(),FUNCAO,(yyvsp[0].tiposvar));
...
#line 146 "src/parser.y"
        ...
        (yyval.arvore) = NULL;
        Symbol *retorno;
        retorno = find_symbol(stack->table,(yyvsp[-3].valor_lexico)->valor);
        if(retorno != NULL){
            printf("Erro na linha %d, parâmetro '%s' já declarado na linha %d\n",get_line_number(), (yyvsp[-3].valor_lexico)->valor, retorno->linha);
            exit(ERR_DECLARED);
        } 
        insert_symbol(stack->table,(yyvsp[-3].valor_lexico)->valor,get_line_number(),IDENTIFICADOR,(yyvsp[0].tiposvar));
    }
...
#line 192 "src/parser.y"
                                                   { 
    if((yyvsp[0].arvore) != NULL) {(yyvsp[0].arvore)->tipo = (yyvsp[-1].tiposvar);}
    (yyval.arvore) = (yyvsp[0].arvore); 
    set_symbol_type(stack->table, (yyvsp[-1].tiposvar));
}
...
#line 210 "src/parser.y"
        ...
        if(identificador != NULL){
            printf("Erro na linha %d, identificador '%s' já declarado na linha %d\n",get_line_number(), (yyvsp[0].valor_lexico)->valor, identificador->linha);
            exit(ERR_DECLARED);
        }
...
#line 219 "src/parser.y"
        ...
        if(identificador != NULL){
            printf("Erro na linha %d, identificador '%s' já declarado na linha %d\n",get_line_number(), (yyvsp[-2].valor_lexico)->valor, identificador->linha);
            exit(ERR_DECLARED);
        }
...
#line 248 "src/parser.y"
                                   { 
            Symbol *symbol = find_symbol_in_stack(stack,(yyvsp[-2].valor_lexico)->valor);
            if(symbol == NULL){
                printf("Erro na linha %d, variavel '%s' nao declarada\n",get_line_number(), (yyvsp[-2].valor_lexico)->valor);
                exit(ERR_UNDECLARED);
            }
            if(symbol->natureza != IDENTIFICADOR) {
                printf("Erro na linha %d, variavel '%s' na verdade é uma funcao declarada na linha %d\n",get_line_number(), (yyvsp[-2].valor_lexico)->valor,symbol->linha);
                exit(ERR_FUNCTION);
            }
            (yyval.arvore) = asd_new("=");
            asd_add_child((yyval.arvore), asd_new((yyvsp[-2].valor_lexico)->valor)); 
...
{ 
    Symbol *symbol = find_symbol_in_stack(stack,(yyvsp[-3].valor_lexico)->valor);
    if(symbol == NULL){
        printf("Erro na linha %d, funcao '%s' nao declarada\n",get_line_number(), (yyvsp[-3].valor_lexico)->valor);
        exit(ERR_UNDECLARED);
    }
    if(symbol->natureza != FUNCAO) {
        printf("Erro na linha %d, funcao '%s' na verdade é uma variavel declarada na linha %d\n",get_line_number(), (yyvsp[-3].valor_lexico)->valor,symbol->linha);
        exit(ERR_VARIABLE);
    }
...
#line 309 "src/parser.y"
                         { 
        (yyval.arvore) = handle_binary_operation("|", (yyvsp[-2].arvore), (yyvsp[0].arvore)); 
        (yyval.arvore)->tipo = type_inference((yyvsp[-2].arvore)->tipo, (yyvsp[0].arvore)->tipo); 
    }
...
#line 398 "src/parser.y"
                { (yyval.arvore) = asd_new("-"); asd_add_child((yyval.arvore),(yyvsp[0].arvore)); (yyval.arvore)->tipo = (yyvsp[0].arvore)->tipo;}
...
#line 2076 "build/parser.tab.c"
  ...
  case 73: /* expr1: TK_IDENTIFICADOR  */
#line 402 "src/parser.y"
                       { 
        Symbol *symbol = find_symbol_in_stack(stack,(yyvsp[0].valor_lexico)->valor);
        if(symbol == NULL){
            printf("Erro na linha %d, variavel '%s' nao declarada\n",get_line_number(), (yyvsp[0].valor_lexico)->valor);
            exit(ERR_UNDECLARED);
        }
        if(symbol->natureza != IDENTIFICADOR) {
            printf("Erro na linha %d, variavel '%s' na verdade é uma funcao declarada na linha %d\n",get_line_number(), (yyvsp[0].valor_lexico)->valor,symbol->linha);
            exit(ERR_FUNCTION);
        }
        (yyval.arvore) = asd_new((yyvsp[0].valor_lexico)->valor); 
        (yyval.arvore)->tipo = symbol->tipo;
        valor_lexico_free((yyvsp[0].valor_lexico)); 
    }
