...
static const yytype_int16 yyrline[] =
{
     ...
     106,   111,   112,   115,   118,   132,   149,   150,   152,   165,
     168,   169,   171,   172,   175,   176,   183,   189,   193,   194,
     195,   196,   197,   200,   213,   218,   244,   256,   268,   285,
     292,   310,   311,   314,   318,   323,   329,   333,   336,   337,
     340,   341,   344,   345,   346,   349,   350,   351,   352,   353,
...
#line 336 "src/parser.y"
                         {(yyval.arvore) = asd_new("|"); asd_add_child((yyval.arvore),(yyvsp[-2].arvore)); asd_add_child((yyval.arvore),(yyvsp[0].arvore));  (yyval.arvore)->tipo = type_inference((yyvsp[-2].arvore)->tipo,(yyvsp[0].arvore)->tipo); }
...
#line 2025 "build/parser.tab.c"
  ...
  case 71: /* expr1: chamada_funcao  */
#line 371 "src/parser.y"
                  { (yyval.arvore) = (yyvsp[0].arvore); }
#line 2031 "build/parser.tab.c"
    break;

  case 72: /* expr1: '(' expressao ')'  */
